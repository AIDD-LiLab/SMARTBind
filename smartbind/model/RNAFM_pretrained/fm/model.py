...
class RNABertModel(nn.Module):
    ...
    def __init__(self, args, alphabet, device='cuda'):
        super().__init__()
        self.args = args
    ...
    def _init_submodules_esm1b(self):
        ...
        self.embed_scale = 1
        self.embed_positions = LearnedPositionalEmbedding(self.args.max_positions,
                                                          self.args.embed_dim,
                                                          self.padding_idx).to(self.device)
        self.emb_layer_norm_before = ESM1bLayerNorm(self.args.embed_dim).to(self.device)
        self.emb_layer_norm_after = ESM1bLayerNorm(self.args.embed_dim).to(self.device)
    ...
    def _init_submodules_esm1(self):
        ...
        self.embed_positions = SinusoidalPositionalEmbedding(self.args.embed_dim, self.padding_idx).to(self.device)
