...
class BindingPredictor(nn.Module):
    def __init__(self, smol_dim, rna_dim, hidden_dim, dropout_rate=0.2, attention_dropout_rate=0.3, use_attention=True):
        super(BindingPredictor, self).__init__()
        self.cross_attention = CrossAttention(smol_dim, rna_dim, hidden_dim, dropout_rate, attention_dropout_rate, use_attention)
